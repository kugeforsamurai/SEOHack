...
def axes_prompt(topic: str, cases_csv: str, user_feedback: str = "") -> str:
    feedback_block = ""
...
def outline_prompt(topic: str, angle_md: str, cases_csv: str = "") -> str:
    cases_block = ""
    if cases_csv.strip():
        cases_block = f"""\
...
def lead_prompt(topic: str, title: str, lead_direction: str, outline_md: str) -> str:
